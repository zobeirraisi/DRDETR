...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        loss_bbox = F.l1_loss(
            Rbox_ops.box_center_to_corners(src_boxes),
            Rbox_ops.box_center_to_corners(target_boxes),
            reduction="none",
        )
        # loss_bbox = torch.nn.SmoothL1Loss(reduction="none")(src_boxes, target_boxes)
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        boxes = Rbox_ops.box_center_to_corners(out_bbox)
        print(boxes)
        boxes = box_ops.corners_to_xy(boxes)
        print(boxes)
